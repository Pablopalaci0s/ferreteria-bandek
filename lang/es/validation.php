...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor indicado para :attribute apareció en una filtración de datos. Elegí otro :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Traducciones de los nombres de campo que usa la app, para que los
    | mensajes de arriba digan "El campo Nombre..." en vez de "El campo
    | nombre..." o el nombre tecnico de la columna en la base de datos.
    |
    */
